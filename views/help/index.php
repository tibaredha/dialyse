...
<ul>
  <li><?php echo '<a href="'.URL.'fpdf/doc/Arretéar.pdf">Arretéar.pdf</a>';echo '&nbsp;';?></li>
  <li><?php echo '<a href="'.URL.'fpdf/doc/Arretéfr.pdf">Arretéfr.pdf</a>';echo '&nbsp;';?></li>
  <li><?php echo '<a href="'.URL.'fpdf/doc/Courrier Registre IRCT.PDF">Courrier Registre IRCT.PDF</a>';echo '&nbsp;';?></li>
